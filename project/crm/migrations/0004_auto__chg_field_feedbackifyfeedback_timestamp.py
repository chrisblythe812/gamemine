...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedbackifyFeedback.timestamp'
        db.alter_column('crm_feedbackifyfeedback', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'FeedbackifyFeedback.timestamp'
        db.alter_column('crm_feedbackifyfeedback', 'timestamp', self.gf('django.db.models.fields.DateField')(null=True))
