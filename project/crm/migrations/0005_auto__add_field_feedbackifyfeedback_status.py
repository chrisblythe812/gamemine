...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeedbackifyFeedback.status'
        db.add_column('crm_feedbackifyfeedback', 'status', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeedbackifyFeedback.status'
        db.delete_column('crm_feedbackifyfeedback', 'status')
