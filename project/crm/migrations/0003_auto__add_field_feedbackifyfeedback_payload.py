...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeedbackifyFeedback.payload'
        db.add_column('crm_feedbackifyfeedback', 'payload', self.gf('django_snippets.thirdparty.models.json_field.JSONField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeedbackifyFeedback.payload'
        db.delete_column('crm_feedbackifyfeedback', 'payload')
