...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeedbackifyFeedback.user'
        db.add_column('crm_feedbackifyfeedback', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeedbackifyFeedback.user'
        db.delete_column('crm_feedbackifyfeedback', 'user_id')
