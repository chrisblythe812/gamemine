...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Item.rent_status_percent'
        db.delete_column('catalog_item', 'rent_status_percent')

        # Adding field 'Item.rent_status'
        db.add_column('catalog_item', 'rent_status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Item.rent_status_percent'
        db.add_column('catalog_item', 'rent_status_percent', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Item.rent_status'
        db.delete_column('catalog_item', 'rent_status')
