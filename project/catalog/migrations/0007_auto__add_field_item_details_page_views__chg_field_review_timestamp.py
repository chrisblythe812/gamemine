...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.details_page_views'
        db.add_column('catalog_item', 'details_page_views', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True), keep_default=False)

        # Changing field 'Review.timestamp'
        db.alter_column('catalog_review', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Deleting field 'Item.details_page_views'
        db.delete_column('catalog_item', 'details_page_views')

        # Changing field 'Review.timestamp'
        db.alter_column('catalog_review', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))
