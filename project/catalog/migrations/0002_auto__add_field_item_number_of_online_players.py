...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.number_of_online_players'
        db.add_column('catalog_item', 'number_of_online_players', self.gf('django.db.models.fields.SmallIntegerField')(db_index=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.number_of_online_players'
        db.delete_column('catalog_item', 'number_of_online_players')
