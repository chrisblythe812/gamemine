...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ItemViewsStat'
        db.create_table('catalog_itemviewsstat', (
        ...
        db.send_create_signal('catalog', ['ItemViewsStat'])


    def backwards(self, orm):
        
        # Deleting model 'ItemViewsStat'
        db.delete_table('catalog_itemviewsstat')
