...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.bid'
        db.add_column('catalog_category', 'bid', self.gf('django.db.models.fields.CharField')(default=0, max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.bid'
        db.delete_column('catalog_category', 'bid')
    ...
    models = {
        ...
        'catalog.reportupload': {
            'Meta': {'ordering': "['-created']", 'object_name': 'ReportUpload'},
        ...
        'catalog.review': {
            'Meta': {'ordering': "('-helpful_index', '-timestamp')", 'object_name': 'Review'},
