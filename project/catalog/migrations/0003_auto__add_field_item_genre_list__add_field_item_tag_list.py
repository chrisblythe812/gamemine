...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.genre_list'
        db.add_column('catalog_item', 'genre_list', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, db_index=True), keep_default=False)

        # Adding field 'Item.tag_list'
        db.add_column('catalog_item', 'tag_list', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.genre_list'
        db.delete_column('catalog_item', 'genre_list')

        # Deleting field 'Item.tag_list'
        db.delete_column('catalog_item', 'tag_list')
