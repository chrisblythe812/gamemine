...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.ingram_code'
        db.add_column('catalog_item', 'ingram_code', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.ingram_code'
        db.delete_column('catalog_item', 'ingram_code')
