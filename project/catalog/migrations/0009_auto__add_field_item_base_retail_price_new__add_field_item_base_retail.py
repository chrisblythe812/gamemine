...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.base_retail_price_new'
        db.add_column('catalog_item', 'base_retail_price_new', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Item.base_retail_price_used'
        db.add_column('catalog_item', 'base_retail_price_used', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Item.base_trade_price'
        db.add_column('catalog_item', 'base_trade_price', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Item.base_trade_price_incomplete'
        db.add_column('catalog_item', 'base_trade_price_incomplete', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.base_retail_price_new'
        db.delete_column('catalog_item', 'base_retail_price_new')

        # Deleting field 'Item.base_retail_price_used'
        db.delete_column('catalog_item', 'base_retail_price_used')

        # Deleting field 'Item.base_trade_price'
        db.delete_column('catalog_item', 'base_trade_price')

        # Deleting field 'Item.base_trade_price_incomplete'
        db.delete_column('catalog_item', 'base_trade_price_incomplete')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True', 'blank': 'True'}),
            'base_retail_price_new': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'base_retail_price_used': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'base_trade_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'base_trade_price_incomplete': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
