...
from project.catalog.models import Rating


class Migration(DataMigration):
    def forwards(self, orm):
        migrate_media_field_forwards(Rating, "image")

    def backwards(self, orm):
        migrate_media_field_backwards(Rating, "image")
    ...
    models = {
        ...
        'catalog.itemviewsstat': {
            'Meta': {'ordering': "['-date']", 'object_name': 'ItemViewsStat'},
