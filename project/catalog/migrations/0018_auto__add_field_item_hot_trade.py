...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.hot_trade'
        db.add_column('catalog_item', 'hot_trade', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.hot_trade'
        db.delete_column('catalog_item', 'hot_trade')
