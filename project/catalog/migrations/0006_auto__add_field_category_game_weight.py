...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.game_weight'
        db.add_column('catalog_category', 'game_weight', self.gf('django.db.models.fields.DecimalField')(default='6.0', max_digits=5, decimal_places=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.game_weight'
        db.delete_column('catalog_category', 'game_weight')
