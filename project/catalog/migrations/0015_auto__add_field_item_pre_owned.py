...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.pre_owned'
        db.add_column('catalog_item', 'pre_owned', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.pre_owned'
        db.delete_column('catalog_item', 'pre_owned')
