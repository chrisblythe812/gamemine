...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.game_weight'
        db.add_column('catalog_item', 'game_weight', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Item.prebook_date'
        db.add_column('catalog_item', 'prebook_date', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.game_weight'
        db.delete_column('catalog_item', 'game_weight')

        # Deleting field 'Item.prebook_date'
        db.delete_column('catalog_item', 'prebook_date')
