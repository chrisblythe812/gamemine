...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Refund'
        db.create_table('members_refund', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('payment', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['members.BillingHistory'], unique=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=512, null=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('members', ['Refund'])


    def backwards(self, orm):
        
        # Deleting model 'Refund'
        db.delete_table('members_refund')
    ...
    models = {
        ...
        'members.refund': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payment': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['members.BillingHistory']", 'unique': 'True'}),
