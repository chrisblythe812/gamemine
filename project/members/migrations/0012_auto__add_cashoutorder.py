...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CashOutOrder'
        db.create_table('members_cashoutorder', (
            ...
            ('process_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('members', ['CashOutOrder'])


    def backwards(self, orm):
        
        # Deleting model 'CashOutOrder'
        db.delete_table('members_cashoutorder')
    ...
    models = {
        ...
        'members.cashoutorder': {
            ...
            'process_date': ('django.db.models.fields.DateTimeField', [], {}),
