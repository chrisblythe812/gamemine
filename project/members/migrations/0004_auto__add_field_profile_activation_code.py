...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.activation_code'
        db.add_column('members_profile', 'activation_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.activation_code'
        db.delete_column('members_profile', 'activation_code')
