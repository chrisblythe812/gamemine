...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Refund.comment'
        db.alter_column('members_refund', 'comment', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True))

        # Changing field 'Refund.payment'
        db.alter_column('members_refund', 'payment_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['members.BillingHistory'], unique=True, null=True))

        # Adding field 'Profile.group'
        db.add_column('members_profile', 'group', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Refund.comment'
        db.alter_column('members_refund', 'comment', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'Refund.payment'
        db.alter_column('members_refund', 'payment_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['members.BillingHistory'], unique=True))

        # Deleting field 'Profile.group'
        db.delete_column('members_profile', 'group')
