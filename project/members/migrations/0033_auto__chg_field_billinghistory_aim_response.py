...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BillingHistory.aim_response'
        db.alter_column('members_billinghistory', 'aim_response', self.gf('django_snippets.models.blowfish_field.BlowfishField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'BillingHistory.aim_response'
        db.alter_column('members_billinghistory', 'aim_response', self.gf('django_snippets.thirdparty.models.json_field.JSONField')(null=True))
