...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CashOutOrder.address1'
        db.add_column('members_cashoutorder', 'address1', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)

        # Adding field 'CashOutOrder.address2'
        db.add_column('members_cashoutorder', 'address2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'CashOutOrder.city'
        db.add_column('members_cashoutorder', 'city', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)

        # Adding field 'CashOutOrder.county'
        db.add_column('members_cashoutorder', 'county', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)

        # Adding field 'CashOutOrder.state'
        db.add_column('members_cashoutorder', 'state', self.gf('django.db.models.fields.CharField')(max_length=2, null=True), keep_default=False)

        # Adding field 'CashOutOrder.zip_code'
        db.add_column('members_cashoutorder', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CashOutOrder.address1'
        db.delete_column('members_cashoutorder', 'address1')

        # Deleting field 'CashOutOrder.address2'
        db.delete_column('members_cashoutorder', 'address2')

        # Deleting field 'CashOutOrder.city'
        db.delete_column('members_cashoutorder', 'city')

        # Deleting field 'CashOutOrder.county'
        db.delete_column('members_cashoutorder', 'county')

        # Deleting field 'CashOutOrder.state'
        db.delete_column('members_cashoutorder', 'state')

        # Deleting field 'CashOutOrder.zip_code'
        db.delete_column('members_cashoutorder', 'zip_code')
