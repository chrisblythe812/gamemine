...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.parental_control'
        db.add_column('members_profile', 'parental_control', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.parental_control'
        db.delete_column('members_profile', 'parental_control')
