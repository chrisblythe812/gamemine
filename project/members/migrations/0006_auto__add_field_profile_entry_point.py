...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.entry_point'
        db.add_column('members_profile', 'entry_point', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.entry_point'
        db.delete_column('members_profile', 'entry_point')
