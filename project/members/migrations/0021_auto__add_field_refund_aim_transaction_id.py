...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Refund.aim_transaction_id'
        db.add_column('members_refund', 'aim_transaction_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Refund.aim_transaction_id'
        db.delete_column('members_refund', 'aim_transaction_id')
