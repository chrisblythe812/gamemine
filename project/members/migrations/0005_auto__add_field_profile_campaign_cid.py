...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.campaign_cid'
        db.add_column('members_profile', 'campaign_cid', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.campaign_cid'
        db.delete_column('members_profile', 'campaign_cid')
