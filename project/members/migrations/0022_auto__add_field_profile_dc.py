...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.dc'
        db.add_column('members_profile', 'dc', self.gf('django.db.models.fields.related.ForeignKey')(related_name='employees', null=True, to=orm['inventory.Dropship']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.dc'
        db.delete_column('members_profile', 'dc_id')
    ...
    models = {
        ...
        'members.profile': {
            ...
            'dc': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'employees'", 'null': 'True', 'to': "orm['inventory.Dropship']"}),
