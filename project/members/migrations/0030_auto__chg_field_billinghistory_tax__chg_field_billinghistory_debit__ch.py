...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BillingHistory.tax'
        db.alter_column('members_billinghistory', 'tax', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'BillingHistory.debit'
        db.alter_column('members_billinghistory', 'debit', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'BillingHistory.credit'
        db.alter_column('members_billinghistory', 'credit', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'BillingHistory.applied_credits'
        db.alter_column('members_billinghistory', 'applied_credits', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'BillingHistory.tax'
        db.alter_column('members_billinghistory', 'tax', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))

        # Changing field 'BillingHistory.debit'
        db.alter_column('members_billinghistory', 'debit', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))

        # Changing field 'BillingHistory.credit'
        db.alter_column('members_billinghistory', 'credit', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))

        # Changing field 'BillingHistory.applied_credits'
        db.alter_column('members_billinghistory', 'applied_credits', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))
