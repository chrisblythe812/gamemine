...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.shipping_checksum'
        db.add_column('members_profile', 'shipping_checksum', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.shipping_checksum'
        db.delete_column('members_profile', 'shipping_checksum')
