...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BillingHistory.setted'
        db.alter_column('members_billinghistory', 'setted', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Adding field 'Profile.locked_store_credits'
        db.add_column('members_profile', 'locked_store_credits', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=12, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'BillingHistory.setted'
        db.alter_column('members_billinghistory', 'setted', self.gf('django.db.models.fields.BooleanField')())

        # Deleting field 'Profile.locked_store_credits'
        db.delete_column('members_profile', 'locked_store_credits')
