...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillingHistory.refered_transaction'
        db.add_column('members_billinghistory', 'refered_transaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.BillingHistory'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillingHistory.refered_transaction'
        db.delete_column('members_billinghistory', 'refered_transaction_id')
