...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CashOutOrder.process_date'
        db.alter_column('members_cashoutorder', 'process_date', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'CashOutOrder.process_date'
        db.alter_column('members_cashoutorder', 'process_date', self.gf('django.db.models.fields.DateTimeField')())
