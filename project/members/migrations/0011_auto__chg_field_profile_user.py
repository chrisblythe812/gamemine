...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field favorite_genres on 'Profile'
        db.create_table('members_profile_favorite_genres', (
        ...
        db.create_unique('members_profile_favorite_genres', ['profile_id', 'genre_id'])

        # Changing field 'Profile.user'
        db.alter_column('members_profile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))


    def backwards(self, orm):
        
        # Removing M2M table for field favorite_genres on 'Profile'
        db.delete_table('members_profile_favorite_genres')

        # Changing field 'Profile.user'
        db.alter_column('members_profile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
