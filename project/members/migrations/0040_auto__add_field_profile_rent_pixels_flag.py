...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.rent_pixels_flag'
        db.add_column('members_profile', 'rent_pixels_flag', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.rent_pixels_flag'
        db.delete_column('members_profile', 'rent_pixels_flag')
