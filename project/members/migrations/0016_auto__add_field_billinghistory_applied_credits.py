...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillingHistory.applied_credits'
        db.add_column('members_billinghistory', 'applied_credits', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillingHistory.applied_credits'
        db.delete_column('members_billinghistory', 'applied_credits')
