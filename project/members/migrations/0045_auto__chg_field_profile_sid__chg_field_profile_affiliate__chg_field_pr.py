...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.sid'
        db.alter_column('members_profile', 'sid', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Profile.affiliate'
        db.alter_column('members_profile', 'affiliate', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Profile.campaign_cid'
        db.alter_column('members_profile', 'campaign_cid', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):

        # Changing field 'Profile.sid'
        db.alter_column('members_profile', 'sid', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Profile.affiliate'
        db.alter_column('members_profile', 'affiliate', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Profile.campaign_cid'
        db.alter_column('members_profile', 'campaign_cid', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        ...
        'members.profile': {
            ...
            'affiliate': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'campaign_cid': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'db_index': 'True'}),
            ...
            'sid': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'db_index': 'True'}),
