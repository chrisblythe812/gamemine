...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.shipping_address2'
        db.alter_column('members_profile', 'shipping_address2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Profile.shipping_address2'
        db.alter_column('members_profile', 'shipping_address2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
