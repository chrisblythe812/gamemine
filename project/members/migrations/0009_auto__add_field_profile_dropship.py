...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.dropship'
        db.add_column('members_profile', 'dropship', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Dropship'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.dropship'
        db.delete_column('members_profile', 'dropship_id')
    ...
    models = {
        ...
        'members.profile': {
            ...
            'dropship': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['inventory.Dropship']", 'null': 'True'}),
