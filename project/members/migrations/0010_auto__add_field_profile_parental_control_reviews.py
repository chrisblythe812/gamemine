...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.parental_control_reviews'
        db.add_column('members_profile', 'parental_control_reviews', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.parental_control_reviews'
        db.delete_column('members_profile', 'parental_control_reviews')
