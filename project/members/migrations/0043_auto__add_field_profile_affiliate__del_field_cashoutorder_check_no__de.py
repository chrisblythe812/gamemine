...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.affiliate'
        db.add_column('members_profile', 'affiliate', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=20, null=True, blank=True), keep_default=False)

        # Deleting field 'CashOutOrder.check_no'
        db.delete_column('members_cashoutorder', 'check_no')

        # Deleting field 'CashOutOrder.paypal_id'
        db.delete_column('members_cashoutorder', 'paypal_id')

        # Deleting field 'CashOutOrder.processed_by'
        db.delete_column('members_cashoutorder', 'processed_by_id')

        try:
            # # Removing index on 'CashOutOrder', fields ['status']
            db.delete_index('members_cashoutorder', ['status'])
        except:
            pass

        try:
            # Removing index on 'CashOutOrder', fields ['payment_method']
            db.delete_index('members_cashoutorder', ['payment_method'])
        except:
            pass

        try:
            # Changing field 'CashOutOrder.submit_date'
            db.alter_column('members_cashoutorder', 'submit_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        except:
            pass

        try:
            # Removing index on 'CashOutOrder', fields ['submit_date']
            db.delete_index('members_cashoutorder', ['submit_date'])
        except:
            pass

        try:
            # Removing index on 'CashOutOrder', fields ['process_date']
            db.delete_index('members_cashoutorder', ['process_date'])
        except:
            pass

    def backwards(self, orm):
        
        # Adding index on 'CashOutOrder', fields ['process_date']
        db.create_index('members_cashoutorder', ['process_date'])

        # Adding index on 'CashOutOrder', fields ['submit_date']
        db.create_index('members_cashoutorder', ['submit_date'])

        # Adding index on 'CashOutOrder', fields ['payment_method']
        db.create_index('members_cashoutorder', ['payment_method'])

        # Adding index on 'CashOutOrder', fields ['status']
        db.create_index('members_cashoutorder', ['status'])

        # Deleting field 'Profile.affiliate'
        db.delete_column('members_profile', 'affiliate')

        # Adding field 'CashOutOrder.check_no'
        db.add_column('members_cashoutorder', 'check_no', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)

        # Adding field 'CashOutOrder.paypal_id'
        db.add_column('members_cashoutorder', 'paypal_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)

        # Adding field 'CashOutOrder.processed_by'
        db.add_column('members_cashoutorder', 'processed_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='processed_cachouts', null=True, to=orm['auth.User']), keep_default=False)

        # Changing field 'CashOutOrder.submit_date'
        db.alter_column('members_cashoutorder', 'submit_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'members.campaign': {
            'Meta': {'ordering': "['cid']", 'object_name': 'Campaign'},
        ...
        'members.profile': {
            ...
            'affiliate': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '20', 'null': 'True', 'blank': 'True'}),
            ...
            'rent_pixels_flag': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
