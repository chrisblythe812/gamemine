...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('members_campaign', (
            ('cid', self.gf('django.db.models.fields.CharField')(max_length=20, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('members', ['Campaign'])


    def backwards(self, orm):
        
        # Deleting model 'Campaign'
        db.delete_table('members_campaign')
