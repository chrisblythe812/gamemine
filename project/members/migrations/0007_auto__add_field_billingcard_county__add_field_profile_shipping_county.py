...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillingCard.county'
        db.add_column('members_billingcard', 'county', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)

        # Adding field 'Profile.shipping_county'
        db.add_column('members_profile', 'shipping_county', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillingCard.county'
        db.delete_column('members_billingcard', 'county')

        # Deleting field 'Profile.shipping_county'
        db.delete_column('members_profile', 'shipping_county')
