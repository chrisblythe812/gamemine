...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillingHistory.message'
        db.add_column('members_billinghistory', 'message', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True), keep_default=False)

        # Adding field 'BillingHistory.aim_response'
        db.add_column('members_billinghistory', 'aim_response', self.gf('django_snippets.thirdparty.models.json_field.JSONField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillingHistory.message'
        db.delete_column('members_billinghistory', 'message')

        # Deleting field 'BillingHistory.aim_response'
        db.delete_column('members_billinghistory', 'aim_response')
    ...
    models = {
        ...
        'members.billinghistory': {
            ...
            'aim_response': ('django_snippets.thirdparty.models.json_field.JSONField', [], {'null': 'True'}),
