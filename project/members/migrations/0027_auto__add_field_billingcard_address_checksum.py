...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillingCard.address_checksum'
        db.add_column('members_billingcard', 'address_checksum', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillingCard.address_checksum'
        db.delete_column('members_billingcard', 'address_checksum')
