...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillingHistory.card_data'
        db.add_column('members_billinghistory', 'card_data', self.gf('django_snippets.models.blowfish_field.BlowfishField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillingHistory.card_data'
        db.delete_column('members_billinghistory', 'card_data')
