...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.extra_rent_slots'
        db.add_column('members_profile', 'extra_rent_slots', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.extra_rent_slots'
        db.delete_column('members_profile', 'extra_rent_slots')
