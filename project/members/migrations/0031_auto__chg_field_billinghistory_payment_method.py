...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BillingHistory.payment_method'
        db.alter_column('members_billinghistory', 'payment_method', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # Changing field 'BillingHistory.payment_method'
        db.alter_column('members_billinghistory', 'payment_method', self.gf('django.db.models.fields.CharField')(max_length=50))
