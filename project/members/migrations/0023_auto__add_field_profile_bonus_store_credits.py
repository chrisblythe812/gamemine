...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.bonus_store_credits'
        db.add_column('members_profile', 'bonus_store_credits', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=12, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.bonus_store_credits'
        db.delete_column('members_profile', 'bonus_store_credits')
