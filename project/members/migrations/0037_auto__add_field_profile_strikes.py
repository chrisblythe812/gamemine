...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.strikes'
        db.add_column('members_profile', 'strikes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.strikes'
        db.delete_column('members_profile', 'strikes')
