...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AimTransaction.response_code'
        db.add_column('staff_aimtransaction', 'response_code', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'AimTransaction.response_subcode'
        db.add_column('staff_aimtransaction', 'response_subcode', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AimTransaction.response_code'
        db.delete_column('staff_aimtransaction', 'response_code')

        # Deleting field 'AimTransaction.response_subcode'
        db.delete_column('staff_aimtransaction', 'response_subcode')
    ...
    models = {
        ...
        'staff.aimrequest': {
            ...
            'data': ('django_snippets.models.blowfish_field.BlowfishField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
