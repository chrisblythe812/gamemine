...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AimTransaction.card_type'
        db.add_column('staff_aimtransaction', 'card_type', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AimTransaction.card_type'
        db.delete_column('staff_aimtransaction', 'card_type')
