...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AimRequest.data'
        db.alter_column('staff_aimrequest', 'data', self.gf('django_snippets.thirdparty.models.json_field.JSONField')())

        # Changing field 'AimResponse.data'
        db.alter_column('staff_aimresponse', 'data', self.gf('django_snippets.thirdparty.models.json_field.JSONField')())
