...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AimResponse.email_address'
        db.add_column('staff_aimresponse', 'email_address', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AimResponse.email_address'
        db.delete_column('staff_aimresponse', 'email_address')
