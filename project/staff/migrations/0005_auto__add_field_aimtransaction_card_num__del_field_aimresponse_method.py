...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AimTransaction.card_num'
        db.add_column('staff_aimtransaction', 'card_num', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, db_index=True), keep_default=False)

        # Deleting field 'AimResponse.method'
        db.delete_column('staff_aimresponse', 'method')


    def backwards(self, orm):
        
        # Deleting field 'AimTransaction.card_num'
        db.delete_column('staff_aimtransaction', 'card_num')

        # Adding field 'AimResponse.method'
        db.add_column('staff_aimresponse', 'method', self.gf('django.db.models.fields.CharField')(max_length=32, null=True), keep_default=False)
