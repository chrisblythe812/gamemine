...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentOrder.date_prepared'
        db.add_column('rent_rentorder', 'date_prepared', self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True), keep_default=False)

        # Adding field 'RentOrder.inventory'
        db.add_column('rent_rentorder', 'inventory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Inventory'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RentOrder.date_prepared'
        db.delete_column('rent_rentorder', 'date_prepared')

        # Deleting field 'RentOrder.inventory'
        db.delete_column('rent_rentorder', 'inventory_id')
