...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RentOrderEvent'
        db.create_table('rent_rentorderevent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='events', to=orm['rent.RentOrder'])),
        ...
        db.send_create_signal('rent', ['RentOrderEvent'])


    def backwards(self, orm):
        
        # Deleting model 'RentOrderEvent'
        db.delete_table('rent_rentorderevent')
