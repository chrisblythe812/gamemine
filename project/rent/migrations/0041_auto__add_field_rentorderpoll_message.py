...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentOrderPoll.message'
        db.add_column('rent_rentorderpoll', 'message', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RentOrderPoll.message'
        db.delete_column('rent_rentorderpoll', 'message')
