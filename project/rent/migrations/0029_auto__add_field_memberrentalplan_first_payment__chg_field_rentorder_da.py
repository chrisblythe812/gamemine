...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberRentalPlan.first_payment'
        db.add_column('rent_memberrentalplan', 'first_payment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.BillingHistory'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MemberRentalPlan.first_payment'
        db.delete_column('rent_memberrentalplan', 'first_payment_id')

        # Changing field 'RentOrder.date_rent'
        db.alter_column('rent_rentorder', 'date_rent', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True))
    ...
    models = {
        ...
        'rent.rentorder': {
            ...
            'date_rent': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
