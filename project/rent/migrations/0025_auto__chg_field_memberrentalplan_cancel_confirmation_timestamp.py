...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MemberRentalPlan.cancel_confirmation_timestamp'
        db.alter_column('rent_memberrentalplan', 'cancel_confirmation_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'MemberRentalPlan.cancel_confirmation_timestamp'
        db.alter_column('rent_memberrentalplan', 'cancel_confirmation_timestamp', self.gf('django.db.models.fields.DateTimeField')())
