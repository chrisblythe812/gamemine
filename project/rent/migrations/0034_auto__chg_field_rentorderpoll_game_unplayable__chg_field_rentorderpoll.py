...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'RentOrderPoll.game_unplayable'
        db.alter_column('rent_rentorderpoll', 'game_unplayable', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True))

        # Changing field 'RentOrderPoll.game_broken'
        db.alter_column('rent_rentorderpoll', 'game_broken', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True))

        # Changing field 'RentOrderPoll.game_missing'
        db.alter_column('rent_rentorderpoll', 'game_missing', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True))
