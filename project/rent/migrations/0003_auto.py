...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'RentList', fields ['added']
        db.create_index('rent_rentlist', ['added'])

        # Adding index on 'RentList', fields ['order']
        db.create_index('rent_rentlist', ['order'])


    def backwards(self, orm):
        
        # Removing index on 'RentList', fields ['added']
        db.delete_index('rent_rentlist', ['added'])

        # Removing index on 'RentList', fields ['order']
        db.delete_index('rent_rentlist', ['order'])
