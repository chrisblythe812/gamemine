...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MemberRentalPlan.next_payment_amout'
        db.delete_column('rent_memberrentalplan', 'next_payment_amout')

        # Adding field 'MemberRentalPlan.next_payment_amount'
        db.add_column('rent_memberrentalplan', 'next_payment_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'MemberRentalPlan.next_payment_amout'
        db.add_column('rent_memberrentalplan', 'next_payment_amout', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2), keep_default=False)

        # Deleting field 'MemberRentalPlan.next_payment_amount'
        db.delete_column('rent_memberrentalplan', 'next_payment_amount')
