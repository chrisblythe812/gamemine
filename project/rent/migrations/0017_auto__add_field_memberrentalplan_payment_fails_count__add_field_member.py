...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberRentalPlan.payment_fails_count'
        db.add_column('rent_memberrentalplan', 'payment_fails_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'MemberRentalPlan.delinquent_next_check'
        db.add_column('rent_memberrentalplan', 'delinquent_next_check', self.gf('django.db.models.fields.DateField')(null=True, db_index=True), keep_default=False)

        # Adding field 'MemberRentalPlan.delinquent_amout'
        db.add_column('rent_memberrentalplan', 'delinquent_amout', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2), keep_default=False)

        # Adding index on 'MemberRentalPlan', fields ['next_payment_date']
        db.create_index('rent_memberrentalplan', ['next_payment_date'])


    def backwards(self, orm):
        
        # Deleting field 'MemberRentalPlan.payment_fails_count'
        db.delete_column('rent_memberrentalplan', 'payment_fails_count')

        # Deleting field 'MemberRentalPlan.delinquent_next_check'
        db.delete_column('rent_memberrentalplan', 'delinquent_next_check')

        # Deleting field 'MemberRentalPlan.delinquent_amout'
        db.delete_column('rent_memberrentalplan', 'delinquent_amout')

        # Removing index on 'MemberRentalPlan', fields ['next_payment_date']
        db.delete_index('rent_memberrentalplan', ['next_payment_date'])
