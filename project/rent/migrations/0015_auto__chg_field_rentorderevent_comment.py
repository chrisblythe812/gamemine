...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RentOrderEvent.comment'
        db.alter_column('rent_rentorderevent', 'comment', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))


    def backwards(self, orm):
        
        # Changing field 'RentOrderEvent.comment'
        db.alter_column('rent_rentorderevent', 'comment', self.gf('django.db.models.fields.CharField')(max_length=512))
