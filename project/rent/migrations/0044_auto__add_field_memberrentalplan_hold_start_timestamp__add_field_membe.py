...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberRentalPlan.hold_start_timestamp'
        db.add_column('rent_memberrentalplan', 'hold_start_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'MemberRentalPlan.hold_reactivate_timestamp'
        db.add_column('rent_memberrentalplan', 'hold_reactivate_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MemberRentalPlan.hold_start_timestamp'
        db.delete_column('rent_memberrentalplan', 'hold_start_timestamp')

        # Deleting field 'MemberRentalPlan.hold_reactivate_timestamp'
        db.delete_column('rent_memberrentalplan', 'hold_reactivate_timestamp')
    ...
    models = {
        ...
        'rent.rentorder': {
            ...
            'list_item': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['rent.RentList']", 'unique': 'True', 'null': 'True'}),
