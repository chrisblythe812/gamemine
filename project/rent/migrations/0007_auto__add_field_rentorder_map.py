...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentOrder.map'
        db.add_column('rent_rentorder', 'map', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RentOrder.map'
        db.delete_column('rent_rentorder', 'map')
