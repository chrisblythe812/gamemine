...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberRentalPlan.downgraded_plan'
        db.add_column('rent_memberrentalplan', 'downgraded_plan', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MemberRentalPlan.downgraded_plan'
        db.delete_column('rent_memberrentalplan', 'downgraded_plan')
    ...
    models = {
        ...
        'rent.memberrentalplan': {
            ...
            'downgraded_plan': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
        ...
        'rent.rentorder': {
            ...
            'scanned_in_route': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True', 'blank': 'True'}),
