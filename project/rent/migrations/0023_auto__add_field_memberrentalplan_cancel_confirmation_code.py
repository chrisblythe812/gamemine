...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberRentalPlan.cancel_confirmation_code'
        db.add_column('rent_memberrentalplan', 'cancel_confirmation_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MemberRentalPlan.cancel_confirmation_code'
        db.delete_column('rent_memberrentalplan', 'cancel_confirmation_code')
