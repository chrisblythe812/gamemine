...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentOrder.list_item'
        db.add_column('rent_rentorder', 'list_item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rent.RentList'], unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RentOrder.list_item'
        db.delete_column('rent_rentorder', 'list_item_id')
