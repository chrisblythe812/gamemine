...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberRentalPlan.card_expired'
        db.add_column('rent_memberrentalplan', 'card_expired', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MemberRentalPlan.card_expired'
        db.delete_column('rent_memberrentalplan', 'card_expired')
