...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberRentalPlan.cancel_confirmation_timestamp'
        db.add_column('rent_memberrentalplan', 'cancel_confirmation_timestamp', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MemberRentalPlan.cancel_confirmation_timestamp'
        db.delete_column('rent_memberrentalplan', 'cancel_confirmation_timestamp')
    ...
    models = {
        ...
        'rent.memberrentalplan': {
            ...
            'cancel_confirmation_timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'db_index': 'True'}),
