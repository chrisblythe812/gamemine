...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BaseMemberRentalPlan.next_payment_type'
        db.add_column('rent_memberrentalplan', 'next_payment_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BaseMemberRentalPlan.next_payment_type'
        db.delete_column('rent_memberrentalplan', 'next_payment_type')
