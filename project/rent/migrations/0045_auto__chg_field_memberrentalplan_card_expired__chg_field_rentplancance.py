...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MemberRentalPlan.card_expired'
        db.alter_column('rent_memberrentalplan', 'card_expired', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RentPlanCancellationReason.too_many_shipping_problems'
        db.alter_column('rent_rentplancancellationreason', 'too_many_shipping_problems', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RentPlanCancellationReason.moving_traveling'
        db.alter_column('rent_rentplancancellationreason', 'moving_traveling', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RentPlanCancellationReason.service_costs_too_much'
        db.alter_column('rent_rentplancancellationreason', 'service_costs_too_much', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RentPlanCancellationReason.not_enough_variety_of_games'
        db.alter_column('rent_rentplancancellationreason', 'not_enough_variety_of_games', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RentPlanCancellationReason.poor_inventory_availability'
        db.alter_column('rent_rentplancancellationreason', 'poor_inventory_availability', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RentPlanCancellationReason.website_is_not_user_friendly'
        db.alter_column('rent_rentplancancellationreason', 'website_is_not_user_friendly', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RentPlanCancellationReason.poor_customer_service'
        db.alter_column('rent_rentplancancellationreason', 'poor_customer_service', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RentPlanCancellationReason.switching_to_another_service'
        db.alter_column('rent_rentplancancellationreason', 'switching_to_another_service', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RentPlanCancellationReason.shipping_to_slow'
        db.alter_column('rent_rentplancancellationreason', 'shipping_to_slow', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RentPlanCancellationReason.only_signed_up_for_promotion'
        db.alter_column('rent_rentplancancellationreason', 'only_signed_up_for_promotion', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CancellationReason.moving_traveling'
        db.alter_column('rent_cancellationreason', 'moving_traveling', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CancellationReason.service_costs_too_much'
        db.alter_column('rent_cancellationreason', 'service_costs_too_much', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CancellationReason.is_confirmed'
        db.alter_column('rent_cancellationreason', 'is_confirmed', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CancellationReason.shipping_to_slow'
        db.alter_column('rent_cancellationreason', 'shipping_to_slow', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CancellationReason.not_enough_variety_of_games'
        db.alter_column('rent_cancellationreason', 'not_enough_variety_of_games', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CancellationReason.poor_inventory_availability'
        db.alter_column('rent_cancellationreason', 'poor_inventory_availability', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CancellationReason.website_is_not_user_friendly'
        db.alter_column('rent_cancellationreason', 'website_is_not_user_friendly', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CancellationReason.poor_customer_service'
        db.alter_column('rent_cancellationreason', 'poor_customer_service', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CancellationReason.switching_to_another_service'
        db.alter_column('rent_cancellationreason', 'switching_to_another_service', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CancellationReason.too_many_shipping_problems'
        db.alter_column('rent_cancellationreason', 'too_many_shipping_problems', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CancellationReason.only_signed_up_for_promotion'
        db.alter_column('rent_cancellationreason', 'only_signed_up_for_promotion', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RentOrderPoll.game_unplayable'
        db.alter_column('rent_rentorderpoll', 'game_unplayable', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RentOrderPoll.game_broken'
        db.alter_column('rent_rentorderpoll', 'game_broken', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RentOrderPoll.game_missing'
        db.alter_column('rent_rentorderpoll', 'game_missing', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Adding field 'RentOrder.scanned_in_route'
        db.add_column('rent_rentorder', 'scanned_in_route', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'MemberRentalPlan.card_expired'
        db.alter_column('rent_memberrentalplan', 'card_expired', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RentPlanCancellationReason.too_many_shipping_problems'
        db.alter_column('rent_rentplancancellationreason', 'too_many_shipping_problems', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RentPlanCancellationReason.moving_traveling'
        db.alter_column('rent_rentplancancellationreason', 'moving_traveling', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RentPlanCancellationReason.service_costs_too_much'
        db.alter_column('rent_rentplancancellationreason', 'service_costs_too_much', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RentPlanCancellationReason.not_enough_variety_of_games'
        db.alter_column('rent_rentplancancellationreason', 'not_enough_variety_of_games', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RentPlanCancellationReason.poor_inventory_availability'
        db.alter_column('rent_rentplancancellationreason', 'poor_inventory_availability', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RentPlanCancellationReason.website_is_not_user_friendly'
        db.alter_column('rent_rentplancancellationreason', 'website_is_not_user_friendly', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RentPlanCancellationReason.poor_customer_service'
        db.alter_column('rent_rentplancancellationreason', 'poor_customer_service', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RentPlanCancellationReason.switching_to_another_service'
        db.alter_column('rent_rentplancancellationreason', 'switching_to_another_service', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RentPlanCancellationReason.shipping_to_slow'
        db.alter_column('rent_rentplancancellationreason', 'shipping_to_slow', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RentPlanCancellationReason.only_signed_up_for_promotion'
        db.alter_column('rent_rentplancancellationreason', 'only_signed_up_for_promotion', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CancellationReason.moving_traveling'
        db.alter_column('rent_cancellationreason', 'moving_traveling', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CancellationReason.service_costs_too_much'
        db.alter_column('rent_cancellationreason', 'service_costs_too_much', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CancellationReason.is_confirmed'
        db.alter_column('rent_cancellationreason', 'is_confirmed', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CancellationReason.shipping_to_slow'
        db.alter_column('rent_cancellationreason', 'shipping_to_slow', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CancellationReason.not_enough_variety_of_games'
        db.alter_column('rent_cancellationreason', 'not_enough_variety_of_games', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CancellationReason.poor_inventory_availability'
        db.alter_column('rent_cancellationreason', 'poor_inventory_availability', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CancellationReason.website_is_not_user_friendly'
        db.alter_column('rent_cancellationreason', 'website_is_not_user_friendly', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CancellationReason.poor_customer_service'
        db.alter_column('rent_cancellationreason', 'poor_customer_service', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CancellationReason.switching_to_another_service'
        db.alter_column('rent_cancellationreason', 'switching_to_another_service', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CancellationReason.too_many_shipping_problems'
        db.alter_column('rent_cancellationreason', 'too_many_shipping_problems', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CancellationReason.only_signed_up_for_promotion'
        db.alter_column('rent_cancellationreason', 'only_signed_up_for_promotion', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RentOrderPoll.game_unplayable'
        db.alter_column('rent_rentorderpoll', 'game_unplayable', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RentOrderPoll.game_broken'
        db.alter_column('rent_rentorderpoll', 'game_broken', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RentOrderPoll.game_missing'
        db.alter_column('rent_rentorderpoll', 'game_missing', self.gf('django.db.models.fields.BooleanField')())

        # Deleting field 'RentOrder.scanned_in_route'
        db.delete_column('rent_rentorder', 'scanned_in_route')
    ...
    models = {
        ...
        'rent.memberrentalplan': {
            ...
            'card_expired': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
        ...
        'rent.rentorder': {
            ...
            'scanned_in_route': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
        ...
        'rent.rentorderpoll': {
            ...
            'game_broken': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'game_missing': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'game_unplayable': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_damaged': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['rent.RentOrder']", 'unique': 'True'}),
