...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberRentalPlan.suspend_date'
        db.add_column('rent_memberrentalplan', 'suspend_date', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MemberRentalPlan.suspend_date'
        db.delete_column('rent_memberrentalplan', 'suspend_date')
