...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentOrder.date_shipped_back'
        db.add_column('rent_rentorder', 'date_shipped_back', self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True), keep_default=False)

        # Adding field 'RentOrder.outgoing_tracking_number'
        db.add_column('rent_rentorder', 'outgoing_tracking_number', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)

        # Adding field 'RentOrder.outgoing_tracking_scans'
        db.add_column('rent_rentorder', 'outgoing_tracking_scans', self.gf('django_snippets.thirdparty.models.json_field.JSONField')(null=True), keep_default=False)

        # Adding field 'RentOrder.incoming_tracking_number'
        db.add_column('rent_rentorder', 'incoming_tracking_number', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)

        # Adding field 'RentOrder.incoming_tracking_scans'
        db.add_column('rent_rentorder', 'incoming_tracking_scans', self.gf('django_snippets.thirdparty.models.json_field.JSONField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RentOrder.date_shipped_back'
        db.delete_column('rent_rentorder', 'date_shipped_back')

        # Deleting field 'RentOrder.outgoing_tracking_number'
        db.delete_column('rent_rentorder', 'outgoing_tracking_number')

        # Deleting field 'RentOrder.outgoing_tracking_scans'
        db.delete_column('rent_rentorder', 'outgoing_tracking_scans')

        # Deleting field 'RentOrder.incoming_tracking_number'
        db.delete_column('rent_rentorder', 'incoming_tracking_number')

        # Deleting field 'RentOrder.incoming_tracking_scans'
        db.delete_column('rent_rentorder', 'incoming_tracking_scans')
    ...
    models = {
        ...
        'rent.rentorder': {
            ...
            'date_delivered': ('django.db.models.fields.DateField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'date_shipped_back': ('django.db.models.fields.DateField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
