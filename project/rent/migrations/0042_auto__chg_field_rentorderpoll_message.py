...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RentOrderPoll.message'
        db.alter_column('rent_rentorderpoll', 'message', self.gf('django.db.models.fields.TextField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'RentOrderPoll.message'
        db.alter_column('rent_rentorderpoll', 'message', self.gf('django.db.models.fields.TextField')(null=True))
