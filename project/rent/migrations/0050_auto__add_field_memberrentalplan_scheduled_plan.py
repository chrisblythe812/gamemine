...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberRentalPlan.scheduled_plan'
        db.add_column('rent_memberrentalplan', 'scheduled_plan', self.gf('django.db.models.fields.SmallIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MemberRentalPlan.scheduled_plan'
        db.delete_column('rent_memberrentalplan', 'scheduled_plan')
