...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentOrder.source_dc'
        db.add_column('rent_rentorder', 'source_dc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Dropship'], null=True, blank=True), keep_default=False)

        # Changing field 'MemberRentalPlan.status_message'
        db.alter_column('rent_memberrentalplan', 'status_message', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'RentOrder.source_dc'
        db.delete_column('rent_rentorder', 'source_dc_id')

        # Changing field 'MemberRentalPlan.status_message'
        db.alter_column('rent_memberrentalplan', 'status_message', self.gf('django.db.models.fields.CharField')(max_length=1024))
