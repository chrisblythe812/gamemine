...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'RentList', fields ['weight']
        db.create_index('rent_rentlist', ['weight'])

        # Adding index on 'MemberRentalPlan', fields ['status']
        db.create_index('rent_memberrentalplan', ['status'])


    def backwards(self, orm):
        
        # Removing index on 'RentList', fields ['weight']
        db.delete_index('rent_rentlist', ['weight'])

        # Removing index on 'MemberRentalPlan', fields ['status']
        db.delete_index('rent_memberrentalplan', ['status'])
