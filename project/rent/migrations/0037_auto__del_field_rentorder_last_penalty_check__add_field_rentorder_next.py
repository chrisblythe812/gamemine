...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RentOrder.last_penalty_check'
        db.delete_column('rent_rentorder', 'last_penalty_check')

        # Adding field 'RentOrder.next_penalty_check'
        db.add_column('rent_rentorder', 'next_penalty_check', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'RentOrder.last_penalty_check'
        db.add_column('rent_rentorder', 'last_penalty_check', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Deleting field 'RentOrder.next_penalty_check'
        db.delete_column('rent_rentorder', 'next_penalty_check')
