...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentOrder.speed_2x'
        db.add_column('rent_rentorder', 'speed_2x', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RentOrder.speed_2x'
        db.delete_column('rent_rentorder', 'speed_2x')
    ...
    models = {
        ...
        'rent.memberrentalplan': {
            ...
            'suspend_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'})
        },
