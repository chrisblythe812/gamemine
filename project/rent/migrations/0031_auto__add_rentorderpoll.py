...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RentOrderPoll'
        db.create_table('rent_rentorderpoll', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rent.RentOrder'], unique=True)),
            ('received_match_shipped', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('returned_personal_game', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('is_damaged', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('game_broken', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('game_unplayable', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('game_missing', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal('rent', ['RentOrderPoll'])


    def backwards(self, orm):
        
        # Deleting model 'RentOrderPoll'
        db.delete_table('rent_rentorderpoll')
