...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberRentalPlan.delinquent_tax'
        db.add_column('rent_memberrentalplan', 'delinquent_tax', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MemberRentalPlan.delinquent_tax'
        db.delete_column('rent_memberrentalplan', 'delinquent_tax')
