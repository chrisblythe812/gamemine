...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'RentOrder', fields ['scanned_in_route']
        db.create_index('rent_rentorder', ['scanned_in_route'])


    def backwards(self, orm):
        
        # Removing index on 'RentOrder', fields ['scanned_in_route']
        db.delete_index('rent_rentorder', ['scanned_in_route'])
