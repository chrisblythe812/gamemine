...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RentalPlan'
        db.create_table('rent_rentalplan', (
            ('plan', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('first_month', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
            ('thereafter_months', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
            ('months', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('expire_in', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True)),
            ('store_credits', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=10, decimal_places=2, blank=True)),
            ('games_allowed', self.gf('django.db.models.fields.IntegerField')(default=2)),
        ))
        db.send_create_signal('rent', ['RentalPlan'])

        # Adding model 'MemberRentalPlan'
        db.create_table('rent_memberrentalplan', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('plan', self.gf('django.db.models.fields.IntegerField')()),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('status_message', self.gf('django.db.models.fields.CharField')(default='', max_length=1024)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, db_index=True, blank=True)),
            ('expiration_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('next_payment_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('next_payment_amout', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2)),
        ))
        db.send_create_signal('rent', ['MemberRentalPlan'])

        # Adding model 'RentPlanCancellationReason'
        db.create_table('rent_rentplancancellationreason', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('plan', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('shipping_to_slow', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('too_many_shipping_problems', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('website_is_not_user_friendly', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('switching_to_another_service', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('not_enough_variety_of_games', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('moving_traveling', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('poor_customer_service', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('service_costs_too_much', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('only_signed_up_for_promotion', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('poor_inventory_availability', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal('rent', ['RentPlanCancellationReason'])

        # Adding model 'RentOrder'
        db.create_table('rent_rentorder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Item'])),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('status_message', self.gf('django.db.models.fields.CharField')(default='', max_length=512)),
            ('date_rent', self.gf('django.db.models.fields.DateField')(auto_now_add=True, db_index=True, blank=True)),
            ('date_shipped', self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True)),
            ('date_returned', self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True)),
            ...
            ('outgoing_endicia_data', self.gf('django_snippets.thirdparty.models.json_field.JSONField')(null=True)),
            ('outgoing_mail_label', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ('incoming_endicia_data', self.gf('django_snippets.thirdparty.models.json_field.JSONField')(null=True)),
            ('incoming_mail_label', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ('weight', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('rent', ['RentOrder'])

        # Adding model 'RentList'
        db.create_table('rent_rentlist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('rent', ['RentList'])


    def backwards(self, orm):
        
        # Deleting model 'RentalPlan'
        db.delete_table('rent_rentalplan')

        # Deleting model 'MemberRentalPlan'
        db.delete_table('rent_memberrentalplan')

        # Deleting model 'RentPlanCancellationReason'
        db.delete_table('rent_rentplancancellationreason')

        # Deleting model 'RentOrder'
        db.delete_table('rent_rentorder')

        # Deleting model 'RentList'
        db.delete_table('rent_rentlist')
    ...
    models = {
        ...
        'rent.memberrentalplan': {
            ...
            'status_message': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1024'}),
