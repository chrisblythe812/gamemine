...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentOrderEvent.claim'
        db.add_column('rent_rentorderevent', 'claim', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['claims.Claim'], null=True), keep_default=False)

        # Changing field 'RentOrderEvent.action'
        db.alter_column('rent_rentorderevent', 'action', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))


    def backwards(self, orm):
        
        # Deleting field 'RentOrderEvent.claim'
        db.delete_column('rent_rentorderevent', 'claim_id')

        # Changing field 'RentOrderEvent.action'
        db.alter_column('rent_rentorderevent', 'action', self.gf('django.db.models.fields.CharField')(max_length=256))
