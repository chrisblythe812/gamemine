...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentOrder.return_accepted_by'
        db.add_column('rent_rentorder', 'return_accepted_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='return_accepted_games', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RentOrder.return_accepted_by'
        db.delete_column('rent_rentorder', 'return_accepted_by_id')
