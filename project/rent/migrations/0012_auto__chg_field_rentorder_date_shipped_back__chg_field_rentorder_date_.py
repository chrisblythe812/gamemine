...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RentOrder.date_shipped_back'
        db.alter_column('rent_rentorder', 'date_shipped_back', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))

        # Changing field 'RentOrder.date_shipped'
        db.alter_column('rent_rentorder', 'date_shipped', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))

        # Changing field 'RentOrder.date_prepared'
        db.alter_column('rent_rentorder', 'date_prepared', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))

        # Changing field 'RentOrder.date_delivered'
        db.alter_column('rent_rentorder', 'date_delivered', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))

        # Changing field 'RentOrder.date_returned'
        db.alter_column('rent_rentorder', 'date_returned', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'RentOrder.date_shipped_back'
        db.alter_column('rent_rentorder', 'date_shipped_back', self.gf('django.db.models.fields.DateField')(blank=True, null=True))

        # Changing field 'RentOrder.date_shipped'
        db.alter_column('rent_rentorder', 'date_shipped', self.gf('django.db.models.fields.DateField')(blank=True, null=True))

        # Changing field 'RentOrder.date_prepared'
        db.alter_column('rent_rentorder', 'date_prepared', self.gf('django.db.models.fields.DateField')(blank=True, null=True))

        # Changing field 'RentOrder.date_delivered'
        db.alter_column('rent_rentorder', 'date_delivered', self.gf('django.db.models.fields.DateField')(blank=True, null=True))

        # Changing field 'RentOrder.date_returned'
        db.alter_column('rent_rentorder', 'date_returned', self.gf('django.db.models.fields.DateField')(blank=True, null=True))
