...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberRentalPlan.restored_from_history'
        db.add_column('rent_memberrentalplan', 'restored_from_history', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'MemberRentalPlan.next_payment_amount'
        db.alter_column('rent_memberrentalplan', 'next_payment_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True))

        # Changing field 'MemberRentalPlan.next_payment_date'
        db.alter_column('rent_memberrentalplan', 'next_payment_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True))

        # Changing field 'MemberRentalPlan.suspend_date'
        db.alter_column('rent_memberrentalplan', 'suspend_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'MemberRentalPlan.restored_from_history'
        db.delete_column('rent_memberrentalplan', 'restored_from_history')

        # Changing field 'MemberRentalPlan.next_payment_amount'
        db.alter_column('rent_memberrentalplan', 'next_payment_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'MemberRentalPlan.next_payment_date'
        db.alter_column('rent_memberrentalplan', 'next_payment_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'MemberRentalPlan.suspend_date'
        db.alter_column('rent_memberrentalplan', 'suspend_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'hot_trade': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'inventory.inventory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_new': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True', 'blank': 'True'}),
        ...
        'rent.memberrentalplan': {
            ...
            'restored_from_history': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
        ...
        'rent.rentorder': {
            ...
            'speed_2x': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
