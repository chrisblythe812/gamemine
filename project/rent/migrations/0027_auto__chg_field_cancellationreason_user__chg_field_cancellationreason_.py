...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CancellationReason.user'
        db.alter_column('rent_cancellationreason', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))

        # Changing field 'CancellationReason.plan'
        db.alter_column('rent_cancellationreason', 'plan', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'CancellationReason.user'
        db.alter_column('rent_cancellationreason', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Changing field 'CancellationReason.plan'
        db.alter_column('rent_cancellationreason', 'plan', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'rent.memberrentalplanhistory': {
            ...
            'finish_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'plan': ('django.db.models.fields.IntegerField', [], {}),
