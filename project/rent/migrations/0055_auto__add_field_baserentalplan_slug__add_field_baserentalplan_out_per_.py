...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BaseRentalPlan.slug'
        db.add_column('rent_rentalplan', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'BaseRentalPlan.out_per_month'
        db.add_column('rent_rentalplan', 'out_per_month', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'BaseRentalPlan.next_plan'
        db.add_column('rent_rentalplan', 'next_plan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rent.BaseRentalPlan'], null=True, blank=True), keep_default=False)

        # Adding field 'BaseRentalPlan.first_payment_type'
        db.add_column('rent_rentalplan', 'first_payment_type', self.gf('django.db.models.fields.CharField')(default='AUTH_CAPTURE', max_length=50), keep_default=False)

        # Adding field 'BaseRentalPlan.features'
        db.add_column('rent_rentalplan', 'features', self.gf('django_snippets.thirdparty.models.json_field.JSONField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BaseRentalPlan.slug'
        db.delete_column('rent_rentalplan', 'slug')

        # Deleting field 'BaseRentalPlan.out_per_month'
        db.delete_column('rent_rentalplan', 'out_per_month')

        # Deleting field 'BaseRentalPlan.next_plan'
        db.delete_column('rent_rentalplan', 'next_plan_id')

        # Deleting field 'BaseRentalPlan.first_payment_type'
        db.delete_column('rent_rentalplan', 'first_payment_type')

        # Deleting field 'BaseRentalPlan.features'
        db.delete_column('rent_rentalplan', 'features')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'game_weight': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'genre_list': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            ...
            'prebook_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'tag_list': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '1024', 'null': 'True', 'blank': 'True'}),
        ...
        'rent.basememberrentalplan': {
            'Meta': {'ordering': "['-created']", 'object_name': 'BaseMemberRentalPlan', 'db_table': "'rent_memberrentalplan'"},
            ...
            'next_payment_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'scheduled_plan': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'rent.baserentalplan': {
            'Meta': {'ordering': "['plan']", 'object_name': 'BaseRentalPlan', 'db_table': "'rent_rentalplan'"},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'expire_in': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'features': ('django_snippets.thirdparty.models.json_field.JSONField', [], {'null': 'True', 'blank': 'True'}),
            'first_month': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'first_payment_type': ('django.db.models.fields.CharField', [], {'default': "'AUTH_CAPTURE'", 'max_length': '50'}),
            ...
            'next_plan': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rent.BaseRentalPlan']", 'null': 'True', 'blank': 'True'}),
            'out_per_month': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
