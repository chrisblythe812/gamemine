...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentOrder.shipped_by'
        db.add_column('rent_rentorder', 'shipped_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shipped_rent_orders', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RentOrder.shipped_by'
        db.delete_column('rent_rentorder', 'shipped_by_id')
