...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CancellationReason'
        db.create_table('rent_cancellationreason', (
            ...
            ('is_confirmed', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('confirmation_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_index=True)),
            ('confirmation_date', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True)),
            ('shipping_to_slow', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('too_many_shipping_problems', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('website_is_not_user_friendly', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('switching_to_another_service', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('not_enough_variety_of_games', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('moving_traveling', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('poor_customer_service', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('service_costs_too_much', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('only_signed_up_for_promotion', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('poor_inventory_availability', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('rent', ['CancellationReason'])

        # Changing field 'MemberRentalPlan.user'
        db.alter_column('rent_memberrentalplan', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))


    def backwards(self, orm):
        
        # Deleting model 'CancellationReason'
        db.delete_table('rent_cancellationreason')

        # Changing field 'MemberRentalPlan.user'
        db.alter_column('rent_memberrentalplan', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
