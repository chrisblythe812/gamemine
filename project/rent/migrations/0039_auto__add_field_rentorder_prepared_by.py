...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentOrder.prepared_by'
        db.add_column('rent_rentorder', 'prepared_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prepared_games', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RentOrder.prepared_by'
        db.delete_column('rent_rentorder', 'prepared_by_id')
