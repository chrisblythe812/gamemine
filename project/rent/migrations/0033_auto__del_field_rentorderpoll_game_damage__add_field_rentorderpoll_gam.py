...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RentOrderPoll.game_damage'
        db.delete_column('rent_rentorderpoll', 'game_damage')

        # Adding field 'RentOrderPoll.game_broken'
        db.add_column('rent_rentorderpoll', 'game_broken', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'RentOrderPoll.game_unplayable'
        db.add_column('rent_rentorderpoll', 'game_unplayable', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'RentOrderPoll.game_missing'
        db.add_column('rent_rentorderpoll', 'game_missing', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'RentOrderPoll.game_damage'
        db.add_column('rent_rentorderpoll', 'game_damage', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Deleting field 'RentOrderPoll.game_broken'
        db.delete_column('rent_rentorderpoll', 'game_broken')

        # Deleting field 'RentOrderPoll.game_unplayable'
        db.delete_column('rent_rentorderpoll', 'game_unplayable')

        # Deleting field 'RentOrderPoll.game_missing'
        db.delete_column('rent_rentorderpoll', 'game_missing')
    ...
    models = {
        ...
        'rent.rentorderpoll': {
            ...
            'game_broken': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'game_missing': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'game_unplayable': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
