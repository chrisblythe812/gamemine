...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MemberRentalPlan.cancellation_date'
        db.add_column('rent_memberrentalplan', 'cancellation_date', self.gf('django.db.models.fields.DateField')(null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MemberRentalPlan.cancellation_date'
        db.delete_column('rent_memberrentalplan', 'cancellation_date')
