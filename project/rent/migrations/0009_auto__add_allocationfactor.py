...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AllocationFactor'
        db.create_table('rent_allocationfactor', (
        ...
        db.send_create_signal('rent', ['AllocationFactor'])


    def backwards(self, orm):
        
        # Deleting model 'AllocationFactor'
        db.delete_table('rent_allocationfactor')
