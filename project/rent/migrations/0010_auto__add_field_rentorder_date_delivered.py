...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentOrder.date_delivered'
        db.add_column('rent_rentorder', 'date_delivered', self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RentOrder.date_delivered'
        db.delete_column('rent_rentorder', 'date_delivered')
