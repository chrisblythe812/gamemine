...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rent_memberrentalplan', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Removing unique constraint on 'MemberRentalPlan', fields ['user']
        db.delete_unique('rent_memberrentalplan', ['user_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'MemberRentalPlan', fields ['user']
        db.create_unique('rent_memberrentalplan', ['user_id'])
