...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentList.weight'
        db.add_column('rent_rentlist', 'weight', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'RentOrder.weight'
        db.delete_column('rent_rentorder', 'weight')


    def backwards(self, orm):
        
        # Deleting field 'RentList.weight'
        db.delete_column('rent_rentlist', 'weight')

        # Adding field 'RentOrder.weight'
        db.add_column('rent_rentorder', 'weight', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
