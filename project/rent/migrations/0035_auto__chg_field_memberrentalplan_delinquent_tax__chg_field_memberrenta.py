...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MemberRentalPlan.delinquent_tax'
        db.alter_column('rent_memberrentalplan', 'delinquent_tax', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True))

        # Changing field 'MemberRentalPlan.delinquent_amout'
        db.alter_column('rent_memberrentalplan', 'delinquent_amout', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True))

        # Changing field 'MemberRentalPlan.delinquent_next_check'
        db.alter_column('rent_memberrentalplan', 'delinquent_next_check', self.gf('django.db.models.fields.DateField')(null=True, blank=True))

        # Adding field 'RentOrder.penalty_payment'
        db.add_column('rent_rentorder', 'penalty_payment', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['members.BillingHistory'], unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'MemberRentalPlan.delinquent_tax'
        db.alter_column('rent_memberrentalplan', 'delinquent_tax', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'MemberRentalPlan.delinquent_amout'
        db.alter_column('rent_memberrentalplan', 'delinquent_amout', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'MemberRentalPlan.delinquent_next_check'
        db.alter_column('rent_memberrentalplan', 'delinquent_next_check', self.gf('django.db.models.fields.DateField')(null=True))

        # Deleting field 'RentOrder.penalty_payment'
        db.delete_column('rent_rentorder', 'penalty_payment_id')
