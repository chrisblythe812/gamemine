...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RentOrder.returned_to_dc'
        db.add_column('rent_rentorder', 'returned_to_dc', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='returns', null=True, to=orm['inventory.Dropship']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RentOrder.returned_to_dc'
        db.delete_column('rent_rentorder', 'returned_to_dc_id')
