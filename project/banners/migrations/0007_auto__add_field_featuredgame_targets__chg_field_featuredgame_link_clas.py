...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeaturedGame.targets'
        db.add_column('banners_featuredgame', 'targets', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'FeaturedGame.link_class'
        db.alter_column('banners_featuredgame', 'link_class', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

        # Changing field 'FeaturedGame.url'
        db.alter_column('banners_featuredgame', 'url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

        # Changing field 'FeaturedGame.game'
        db.alter_column('banners_featuredgame', 'game_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Item'], null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'FeaturedGame.targets'
        db.delete_column('banners_featuredgame', 'targets')

        # Changing field 'FeaturedGame.link_class'
        db.alter_column('banners_featuredgame', 'link_class', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'FeaturedGame.url'
        db.alter_column('banners_featuredgame', 'url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'FeaturedGame.game'
        db.alter_column('banners_featuredgame', 'game_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Item'], null=True))
    ...
    models = {
        ...
        'banners.featuredgame': {
            ...
            'targets': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
