...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CatalogBanner'
        db.create_table('banners_catalogbanner', (
        ...
        db.send_create_signal('banners', ['CatalogBanner'])


    def backwards(self, orm):
        
        # Deleting model 'CatalogBanner'
        db.delete_table('banners_catalogbanner')
