...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ListPageBanner'
        db.create_table('banners_listpagebanner', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('list', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Item'])),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True, blank=True)),
        ))
        db.send_create_signal('banners', ['ListPageBanner'])


    def backwards(self, orm):
        
        # Deleting model 'ListPageBanner'
        db.delete_table('banners_listpagebanner')
