...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeaturedGame.category'
        db.alter_column('banners_featuredgame', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Category'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'FeaturedGame.category'
        db.alter_column('banners_featuredgame', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Category']))
