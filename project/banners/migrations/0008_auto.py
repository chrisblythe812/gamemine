...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'FeaturedGame', fields ['targets']
        db.create_index('banners_featuredgame', ['targets'])


    def backwards(self, orm):
        
        # Removing index on 'FeaturedGame', fields ['targets']
        db.delete_index('banners_featuredgame', ['targets'])
