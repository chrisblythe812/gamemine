...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeaturedGame.url'
        db.add_column('banners_featuredgame', 'url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)

        # Adding field 'FeaturedGame.link_class'
        db.add_column('banners_featuredgame', 'link_class', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FeaturedGame.url'
        db.delete_column('banners_featuredgame', 'url')

        # Deleting field 'FeaturedGame.link_class'
        db.delete_column('banners_featuredgame', 'link_class')

        # Changing field 'FeaturedGame.game'
        db.alter_column('banners_featuredgame', 'game_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Item']))
    ...
    models = {
        ...
        'banners.featuredgame': {
            ...
            'game': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Item']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'link_class': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
