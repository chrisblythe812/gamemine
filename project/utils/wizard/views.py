...
from project.utils.wizard.storage import get_storage
from project.utils.wizard.storage.exceptions import NoFileStorageConfigured
from project.utils.wizard.forms import ManagementForm
...
class SessionWizardView(WizardView):
    ...
    """
    storage_name = 'project.utils.wizard.storage.session.SessionStorage'
...
class CookieWizardView(WizardView):
    ...
    """
    storage_name = 'project.utils.wizard.storage.cookie.CookieStorage'
