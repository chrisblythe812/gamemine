...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BuyOrder.user'
        db.alter_column('buy_orders_buyorder', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))


    def backwards(self, orm):
        
        # Changing field 'BuyOrder.user'
        db.alter_column('buy_orders_buyorder', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
