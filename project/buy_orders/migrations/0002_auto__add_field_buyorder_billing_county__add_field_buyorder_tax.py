...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BuyOrder.billing_county'
        db.add_column('buy_orders_buyorder', 'billing_county', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)

        # Adding field 'BuyOrder.tax'
        db.add_column('buy_orders_buyorder', 'tax', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BuyOrder.billing_county'
        db.delete_column('buy_orders_buyorder', 'billing_county')

        # Deleting field 'BuyOrder.tax'
        db.delete_column('buy_orders_buyorder', 'tax')
    ...
    models = {
        ...
        'buy_orders.buyorder': {
            ...
            'tax': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '4'}),
