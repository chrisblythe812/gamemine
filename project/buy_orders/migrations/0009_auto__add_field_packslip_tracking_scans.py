...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PackSlip.tracking_scans'
        db.add_column('buy_orders_packslip', 'tracking_scans', self.gf('django_snippets.thirdparty.models.json_field.JSONField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PackSlip.tracking_scans'
        db.delete_column('buy_orders_packslip', 'tracking_scans')
