...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BuyOrder.shipping_county'
        db.add_column('buy_orders_buyorder', 'shipping_county', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BuyOrder.shipping_county'
        db.delete_column('buy_orders_buyorder', 'shipping_county')
