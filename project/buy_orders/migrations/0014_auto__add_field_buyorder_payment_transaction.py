...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BuyOrder.payment_transaction'
        db.add_column('buy_orders_buyorder', 'payment_transaction', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['members.BillingHistory'], unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BuyOrder.payment_transaction'
        db.delete_column('buy_orders_buyorder', 'payment_transaction_id')
