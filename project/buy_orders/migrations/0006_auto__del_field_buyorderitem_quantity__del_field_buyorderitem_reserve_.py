...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BuyOrderItem.quantity'
        db.delete_column('buy_orders_buyorderitem', 'quantity')

        # Deleting field 'BuyOrderItem.reserve'
        db.delete_column('buy_orders_buyorderitem', 'reserve')

        # Adding field 'BuyOrderItem.status'
        db.add_column('buy_orders_buyorderitem', 'status', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'BuyOrderItem.date_prepared'
        db.add_column('buy_orders_buyorderitem', 'date_prepared', self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True), keep_default=False)

        # Adding field 'BuyOrderItem.date_shipped'
        db.add_column('buy_orders_buyorderitem', 'date_shipped', self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True), keep_default=False)

        # Adding field 'BuyOrderItem.source_dc'
        db.add_column('buy_orders_buyorderitem', 'source_dc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Dropship'], null=True, blank=True), keep_default=False)

        # Adding field 'BuyOrderItem.inventory'
        db.add_column('buy_orders_buyorderitem', 'inventory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Inventory'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'BuyOrderItem.quantity'
        db.add_column('buy_orders_buyorderitem', 'quantity', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'BuyOrderItem.reserve'
        db.add_column('buy_orders_buyorderitem', 'reserve', self.gf('django_snippets.thirdparty.models.json_field.JSONField')(default='{}'), keep_default=False)

        # Deleting field 'BuyOrderItem.status'
        db.delete_column('buy_orders_buyorderitem', 'status')

        # Deleting field 'BuyOrderItem.date_prepared'
        db.delete_column('buy_orders_buyorderitem', 'date_prepared')

        # Deleting field 'BuyOrderItem.date_shipped'
        db.delete_column('buy_orders_buyorderitem', 'date_shipped')

        # Deleting field 'BuyOrderItem.source_dc'
        db.delete_column('buy_orders_buyorderitem', 'source_dc_id')

        # Deleting field 'BuyOrderItem.inventory'
        db.delete_column('buy_orders_buyorderitem', 'inventory_id')
