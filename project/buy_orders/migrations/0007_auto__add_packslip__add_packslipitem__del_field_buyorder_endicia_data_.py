...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PackSlip'
        db.create_table('buy_orders_packslip', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['buy_orders.BuyOrder'])),
            ...
            ('date_shipped', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True)),
            ('source_dc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Dropship'])),
        ))
        db.send_create_signal('buy_orders', ['PackSlip'])

        # Adding model 'PackSlipItem'
        db.create_table('buy_orders_packslipitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slip', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['buy_orders.PackSlip'])),
            ('order_item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['buy_orders.BuyOrderItem'], unique=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
        ))
        db.send_create_signal('buy_orders', ['PackSlipItem'])

        # Deleting field 'BuyOrder.endicia_data'
        db.delete_column('buy_orders_buyorder', 'endicia_data')

        # Deleting field 'BuyOrder.mail_label'
        db.delete_column('buy_orders_buyorder', 'mail_label')

        # Deleting field 'BuyOrder.tracking_number'
        db.delete_column('buy_orders_buyorder', 'tracking_number')


    def backwards(self, orm):
        
        # Deleting model 'PackSlip'
        db.delete_table('buy_orders_packslip')

        # Deleting model 'PackSlipItem'
        db.delete_table('buy_orders_packslipitem')

        # Adding field 'BuyOrder.endicia_data'
        db.add_column('buy_orders_buyorder', 'endicia_data', self.gf('django_snippets.thirdparty.models.json_field.JSONField')(null=True), keep_default=False)

        # Adding field 'BuyOrder.mail_label'
        db.add_column('buy_orders_buyorder', 'mail_label', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True), keep_default=False)

        # Adding field 'BuyOrder.tracking_number'
        db.add_column('buy_orders_buyorder', 'tracking_number', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)
    ...
    models = {
        ...
        'buy_orders.packslip': {
            ...
            'source_dc': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['inventory.Dropship']"}),
