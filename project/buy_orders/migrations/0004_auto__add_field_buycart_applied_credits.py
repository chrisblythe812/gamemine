...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BuyCart.applied_credits'
        db.add_column('buy_orders_buycart', 'applied_credits', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=12, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BuyCart.applied_credits'
        db.delete_column('buy_orders_buycart', 'applied_credits')
