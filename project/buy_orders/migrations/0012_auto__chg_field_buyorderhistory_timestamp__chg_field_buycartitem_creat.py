...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BuyOrderHistory.timestamp'
        db.alter_column('buy_orders_buyorderhistory', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'BuyCartItem.created'
        db.alter_column('buy_orders_buycartitem', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'BuyList.added'
        db.alter_column('buy_orders_buylist', 'added', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'BuyOrder.create_date'
        db.alter_column('buy_orders_buyorder', 'create_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'BuyCart.modified'
        db.alter_column('buy_orders_buycart', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True))

        # Changing field 'PackSlip.created'
        db.alter_column('buy_orders_packslip', 'created', self.gf('django.db.models.fields.DateField')())

        # Changing field 'PackSlipItem.added'
        db.alter_column('buy_orders_packslipitem', 'added', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'BuyOrderHistory.timestamp'
        db.alter_column('buy_orders_buyorderhistory', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))

        # Changing field 'BuyCartItem.created'
        db.alter_column('buy_orders_buycartitem', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))

        # Changing field 'BuyList.added'
        db.alter_column('buy_orders_buylist', 'added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))

        # Changing field 'BuyOrder.create_date'
        db.alter_column('buy_orders_buyorder', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))

        # Changing field 'BuyCart.modified'
        db.alter_column('buy_orders_buycart', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True))

        # Changing field 'PackSlip.created'
        db.alter_column('buy_orders_packslip', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True))

        # Changing field 'PackSlipItem.added'
        db.alter_column('buy_orders_packslipitem', 'added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=datetime.datetime.now, blank=True))
    ...
    models = {
        ...
        'buy_orders.packslipitem': {
            'Meta': {'object_name': 'PackSlipItem'},
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_item': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['buy_orders.BuyOrderItem']", 'unique': 'True'}),
