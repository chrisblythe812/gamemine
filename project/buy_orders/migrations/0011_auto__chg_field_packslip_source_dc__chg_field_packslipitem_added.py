...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PackSlip.source_dc'
        db.alter_column('buy_orders_packslip', 'source_dc_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Dropship'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PackSlip.source_dc'
        db.alter_column('buy_orders_packslip', 'source_dc_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Dropship']))

        # Changing field 'PackSlipItem.added'
        db.alter_column('buy_orders_packslipitem', 'added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))
    ...
    models = {
        ...
        'buy_orders.packslipitem': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'datetime.datetime.now', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
