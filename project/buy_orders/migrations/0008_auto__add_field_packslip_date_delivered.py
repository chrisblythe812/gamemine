...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PackSlip.date_delivered'
        db.add_column('buy_orders_packslip', 'date_delivered', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PackSlip.date_delivered'
        db.delete_column('buy_orders_packslip', 'date_delivered')
