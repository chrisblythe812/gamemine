...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BuyOrder.discounts'
        db.add_column('buy_orders_buyorder', 'discounts', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=12, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BuyOrder.discounts'
        db.delete_column('buy_orders_buyorder', 'discounts')
