...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BuyOrder.total'
        db.alter_column('buy_orders_buyorder', 'total', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'BuyOrder.total'
        db.alter_column('buy_orders_buyorder', 'total', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
