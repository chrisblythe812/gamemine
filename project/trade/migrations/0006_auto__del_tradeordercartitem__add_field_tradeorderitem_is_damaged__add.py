...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'TradeOrderCartItem'
        db.delete_table('trade_tradeordercartitem')

        # Adding field 'TradeOrderItem.is_damaged'
        db.add_column('trade_tradeorderitem', 'is_damaged', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'TradeOrderItem.is_exellent'
        db.add_column('trade_tradeorderitem', 'is_exellent', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'TradeOrderItem.is_like_new'
        db.add_column('trade_tradeorderitem', 'is_like_new', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'TradeOrderItem.is_very_good'
        db.add_column('trade_tradeorderitem', 'is_very_good', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'TradeOrderItem.is_factory_sealed'
        db.add_column('trade_tradeorderitem', 'is_factory_sealed', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'TradeOrderItem.is_broken'
        db.add_column('trade_tradeorderitem', 'is_broken', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'TradeOrderItem.is_unplayable'
        db.add_column('trade_tradeorderitem', 'is_unplayable', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'TradeOrderItem.is_lightly_scratched'
        db.add_column('trade_tradeorderitem', 'is_lightly_scratched', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'TradeOrderItem.is_heavily_scratched'
        db.add_column('trade_tradeorderitem', 'is_heavily_scratched', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'TradeOrderItem.is_refurblished'
        db.add_column('trade_tradeorderitem', 'is_refurblished', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'TradeOrderItem.is_mailback'
        db.add_column('trade_tradeorderitem', 'is_mailback', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'TradeOrderCartItem'
        db.create_table('trade_tradeordercartitem', (
            ('price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cart_items', to=orm['trade.TradeOrder'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Item'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('trade', ['TradeOrderCartItem'])

        # Deleting field 'TradeOrderItem.is_damaged'
        db.delete_column('trade_tradeorderitem', 'is_damaged')

        # Deleting field 'TradeOrderItem.is_exellent'
        db.delete_column('trade_tradeorderitem', 'is_exellent')

        # Deleting field 'TradeOrderItem.is_like_new'
        db.delete_column('trade_tradeorderitem', 'is_like_new')

        # Deleting field 'TradeOrderItem.is_very_good'
        db.delete_column('trade_tradeorderitem', 'is_very_good')

        # Deleting field 'TradeOrderItem.is_factory_sealed'
        db.delete_column('trade_tradeorderitem', 'is_factory_sealed')

        # Deleting field 'TradeOrderItem.is_broken'
        db.delete_column('trade_tradeorderitem', 'is_broken')

        # Deleting field 'TradeOrderItem.is_unplayable'
        db.delete_column('trade_tradeorderitem', 'is_unplayable')

        # Deleting field 'TradeOrderItem.is_lightly_scratched'
        db.delete_column('trade_tradeorderitem', 'is_lightly_scratched')

        # Deleting field 'TradeOrderItem.is_heavily_scratched'
        db.delete_column('trade_tradeorderitem', 'is_heavily_scratched')

        # Deleting field 'TradeOrderItem.is_refurblished'
        db.delete_column('trade_tradeorderitem', 'is_refurblished')

        # Deleting field 'TradeOrderItem.is_mailback'
        db.delete_column('trade_tradeorderitem', 'is_mailback')
    ...
    models = {
        ...
        'trade.tradeorderitem': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_broken': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'is_complete': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'is_damaged': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'is_exellent': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'is_factory_sealed': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'is_heavily_scratched': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'is_lightly_scratched': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'is_like_new': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'is_mailback': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'is_refurblished': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'is_unplayable': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'is_very_good': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Item']"}),
