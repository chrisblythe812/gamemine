...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeOrderItem.bastard_flag'
        db.add_column('trade_tradeorderitem', 'bastard_flag', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TradeOrderItem.bastard_flag'
        db.delete_column('trade_tradeorderitem', 'bastard_flag')
