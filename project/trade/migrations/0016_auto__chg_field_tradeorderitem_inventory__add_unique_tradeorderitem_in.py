...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TradeOrderItem.inventory'
        db.alter_column('trade_tradeorderitem', 'inventory_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['inventory.Inventory']))

        # Adding unique constraint on 'TradeOrderItem', fields ['inventory']
        db.create_unique('trade_tradeorderitem', ['inventory_id'])


    def backwards(self, orm):
        
        # Changing field 'TradeOrderItem.inventory'
        db.alter_column('trade_tradeorderitem', 'inventory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Inventory'], null=True))

        # Removing unique constraint on 'TradeOrderItem', fields ['inventory']
        db.delete_unique('trade_tradeorderitem', ['inventory_id'])
