...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeOrderItem.returning_date'
        db.add_column('trade_tradeorderitem', 'returning_date', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'TradeOrderItem.returning_by'
        db.add_column('trade_tradeorderitem', 'returning_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='returning_trade_items', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TradeOrderItem.returning_date'
        db.delete_column('trade_tradeorderitem', 'returning_date')

        # Deleting field 'TradeOrderItem.returning_by'
        db.delete_column('trade_tradeorderitem', 'returning_by_id')
