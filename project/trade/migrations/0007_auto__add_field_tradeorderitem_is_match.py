...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeOrderItem.is_match'
        db.add_column('trade_tradeorderitem', 'is_match', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TradeOrderItem.is_match'
        db.delete_column('trade_tradeorderitem', 'is_match')
