...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeOrder.bonus'
        db.add_column('trade_tradeorder', 'bonus', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'TradeOrderItem.hot_trade'
        db.add_column('trade_tradeorderitem', 'hot_trade', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TradeOrder.bonus'
        db.delete_column('trade_tradeorder', 'bonus')

        # Deleting field 'TradeOrderItem.hot_trade'
        db.delete_column('trade_tradeorderitem', 'hot_trade')
    ...
    models = {
        ...
        'trade.tradeorderitem': {
            ...
            'bastard_flag': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'declined': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'hot_trade': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
