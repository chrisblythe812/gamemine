...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeOrderItem.processed_by'
        db.add_column('trade_tradeorderitem', 'processed_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TradeOrderItem.processed_by'
        db.delete_column('trade_tradeorderitem', 'processed_by_id')
    ...
    models = {
        ...
        'trade.tradeorderitem': {
            ...
            'processed_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
