...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TradeListItem.is_complete'
        db.alter_column('trade_tradelistitem', 'is_complete', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Deleting field 'TradeOrderItem.decline_reason'
        db.delete_column('trade_tradeorderitem', 'decline_reason')

        # Adding field 'TradeOrderItem.inventory'
        db.add_column('trade_tradeorderitem', 'inventory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Inventory'], null=True), keep_default=False)

        # Changing field 'TradeOrderItem.is_like_new'
        db.alter_column('trade_tradeorderitem', 'is_like_new', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.is_mailback'
        db.alter_column('trade_tradeorderitem', 'is_mailback', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.is_complete'
        db.alter_column('trade_tradeorderitem', 'is_complete', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.is_factory_sealed'
        db.alter_column('trade_tradeorderitem', 'is_factory_sealed', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.is_lightly_scratched'
        db.alter_column('trade_tradeorderitem', 'is_lightly_scratched', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.is_unplayable'
        db.alter_column('trade_tradeorderitem', 'is_unplayable', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.is_refurblished'
        db.alter_column('trade_tradeorderitem', 'is_refurblished', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.is_match'
        db.alter_column('trade_tradeorderitem', 'is_match', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.is_damaged'
        db.alter_column('trade_tradeorderitem', 'is_damaged', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.is_very_good'
        db.alter_column('trade_tradeorderitem', 'is_very_good', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.processed'
        db.alter_column('trade_tradeorderitem', 'processed', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.is_exellent'
        db.alter_column('trade_tradeorderitem', 'is_exellent', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.is_broken'
        db.alter_column('trade_tradeorderitem', 'is_broken', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.declined'
        db.alter_column('trade_tradeorderitem', 'declined', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeOrderItem.is_heavily_scratched'
        db.alter_column('trade_tradeorderitem', 'is_heavily_scratched', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TradeCartItem.is_complete'
        db.alter_column('trade_tradecartitem', 'is_complete', self.gf('django.db.models.fields.BooleanField')(blank=True))


    def backwards(self, orm):
        
        # Changing field 'TradeListItem.is_complete'
        db.alter_column('trade_tradelistitem', 'is_complete', self.gf('django.db.models.fields.BooleanField')())

        # Adding field 'TradeOrderItem.decline_reason'
        db.add_column('trade_tradeorderitem', 'decline_reason', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'TradeOrderItem.inventory'
        db.delete_column('trade_tradeorderitem', 'inventory_id')

        # Changing field 'TradeOrderItem.is_like_new'
        db.alter_column('trade_tradeorderitem', 'is_like_new', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.is_mailback'
        db.alter_column('trade_tradeorderitem', 'is_mailback', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.is_complete'
        db.alter_column('trade_tradeorderitem', 'is_complete', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.is_factory_sealed'
        db.alter_column('trade_tradeorderitem', 'is_factory_sealed', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.is_lightly_scratched'
        db.alter_column('trade_tradeorderitem', 'is_lightly_scratched', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.is_unplayable'
        db.alter_column('trade_tradeorderitem', 'is_unplayable', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.is_refurblished'
        db.alter_column('trade_tradeorderitem', 'is_refurblished', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.is_match'
        db.alter_column('trade_tradeorderitem', 'is_match', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.is_damaged'
        db.alter_column('trade_tradeorderitem', 'is_damaged', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.is_very_good'
        db.alter_column('trade_tradeorderitem', 'is_very_good', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.processed'
        db.alter_column('trade_tradeorderitem', 'processed', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.is_exellent'
        db.alter_column('trade_tradeorderitem', 'is_exellent', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.is_broken'
        db.alter_column('trade_tradeorderitem', 'is_broken', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.declined'
        db.alter_column('trade_tradeorderitem', 'declined', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeOrderItem.is_heavily_scratched'
        db.alter_column('trade_tradeorderitem', 'is_heavily_scratched', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TradeCartItem.is_complete'
        db.alter_column('trade_tradecartitem', 'is_complete', self.gf('django.db.models.fields.BooleanField')())
