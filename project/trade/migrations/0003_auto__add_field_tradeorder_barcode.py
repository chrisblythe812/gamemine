...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeOrder.barcode'
        db.add_column('trade_tradeorder', 'barcode', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TradeOrder.barcode'
        db.delete_column('trade_tradeorder', 'barcode')
