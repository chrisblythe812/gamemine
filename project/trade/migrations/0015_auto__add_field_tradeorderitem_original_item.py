...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeOrderItem.original_item'
        db.add_column('trade_tradeorderitem', 'original_item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='original_trade_items', null=True, to=orm['catalog.Item']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TradeOrderItem.original_item'
        db.delete_column('trade_tradeorderitem', 'original_item_id')
