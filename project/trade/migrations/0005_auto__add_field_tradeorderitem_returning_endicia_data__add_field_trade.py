...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeOrderItem.returning_endicia_data'
        db.add_column('trade_tradeorderitem', 'returning_endicia_data', self.gf('django_snippets.thirdparty.models.json_field.JSONField')(null=True), keep_default=False)

        # Adding field 'TradeOrderItem.returning_mail_label'
        db.add_column('trade_tradeorderitem', 'returning_mail_label', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TradeOrderItem.returning_endicia_data'
        db.delete_column('trade_tradeorderitem', 'returning_endicia_data')

        # Deleting field 'TradeOrderItem.returning_mail_label'
        db.delete_column('trade_tradeorderitem', 'returning_mail_label')
    ...
    models = {
        ...
        'trade.tradeordercartitem': {
            'Meta': {'object_name': 'TradeOrderCartItem'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Item']"}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cart_items'", 'to': "orm['trade.TradeOrder']"}),
