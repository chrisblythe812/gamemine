...
class Migration(DataMigration):
    def forwards(self, orm):
        migrate_media_field_forwards(TradeOrderItem, "returning_mail_label")

    def backwards(self, orm):
        migrate_media_field_backwards(TradeOrderItem, "returning_mail_label")
    ...
    models = {
        ...
        'trade.tradeorder': {
            ...
            'bonus': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
        ...
        'trade.tradeorderitem': {
            'Meta': {'ordering': "['id']", 'object_name': 'TradeOrderItem'},
            'bastard_flag': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'declined': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hot_trade': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inventory': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'trade_item'", 'unique': 'True', 'null': 'True', 'to': "orm['inventory.Inventory']"}),
            ...
            'item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'trade_items'", 'to': "orm['catalog.Item']"}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': "orm['trade.TradeOrder']"}),
            'original_item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'original_trade_items'", 'null': 'True', 'to': "orm['catalog.Item']"}),
            'price': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'processed': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'processed_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'processed_trade_items'", 'null': 'True', 'to': "orm['auth.User']"}),
            'processed_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),
            'returning_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'returning_trade_items'", 'null': 'True', 'to': "orm['auth.User']"}),
            'returning_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
