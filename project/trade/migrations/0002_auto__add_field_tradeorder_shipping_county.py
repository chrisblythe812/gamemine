...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TradeOrder.shipping_county'
        db.add_column('trade_tradeorder', 'shipping_county', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TradeOrder.shipping_county'
        db.delete_column('trade_tradeorder', 'shipping_county')
