...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TradeOrderItem.is_like_new'
        db.alter_column('trade_tradeorderitem', 'is_like_new', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TradeOrderItem.is_lightly_scratched'
        db.alter_column('trade_tradeorderitem', 'is_lightly_scratched', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TradeOrderItem.is_unplayable'
        db.alter_column('trade_tradeorderitem', 'is_unplayable', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TradeOrderItem.is_damaged'
        db.alter_column('trade_tradeorderitem', 'is_damaged', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TradeOrderItem.is_exellent'
        db.alter_column('trade_tradeorderitem', 'is_exellent', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TradeOrderItem.is_mailback'
        db.alter_column('trade_tradeorderitem', 'is_mailback', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TradeOrderItem.is_factory_sealed'
        db.alter_column('trade_tradeorderitem', 'is_factory_sealed', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TradeOrderItem.is_broken'
        db.alter_column('trade_tradeorderitem', 'is_broken', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TradeOrderItem.is_heavily_scratched'
        db.alter_column('trade_tradeorderitem', 'is_heavily_scratched', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TradeOrderItem.is_refurblished'
        db.alter_column('trade_tradeorderitem', 'is_refurblished', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TradeOrderItem.is_match'
        db.alter_column('trade_tradeorderitem', 'is_match', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TradeOrderItem.is_very_good'
        db.alter_column('trade_tradeorderitem', 'is_very_good', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        'trade.tradeorderitem': {
            ...
            'is_match': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
