...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TradeOrderItem.quantity'
        db.delete_column('trade_tradeorderitem', 'quantity')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'TradeOrderItem.quantity'
        db.add_column('trade_tradeorderitem', 'quantity', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
