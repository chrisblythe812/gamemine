...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('claims_claim', 'status', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Claim.status'
        db.delete_column('claims_claim', 'status')
