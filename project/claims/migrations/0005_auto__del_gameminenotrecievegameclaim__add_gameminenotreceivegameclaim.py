...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GamemineNotReceiveGameClaim'
        db.create_table('claims_gameminenotreceivegameclaim', (
        ...
        db.send_create_signal('claims', ['GamemineNotReceiveGameClaim'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'GamemineNotReceiveGameClaim'
        db.delete_table('claims_gameminenotreceivegameclaim')
