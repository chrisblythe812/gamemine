...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DontReceiveClaim'
        db.create_table('claims_dontreceiveclaim', (
        ...
        db.send_create_signal('claims', ['DontReceiveClaim'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DontReceiveClaim'
        db.delete_table('claims_dontreceiveclaim')
