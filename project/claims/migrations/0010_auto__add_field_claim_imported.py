...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Claim.imported'
        db.add_column('claims_claim', 'imported', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Claim.imported'
        db.delete_column('claims_claim', 'imported')
