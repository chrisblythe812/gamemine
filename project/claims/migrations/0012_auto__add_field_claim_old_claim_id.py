...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Claim.old_claim_id'
        db.add_column('claims_claim', 'old_claim_id', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Claim.old_claim_id'
        db.delete_column('claims_claim', 'old_claim_id')
