...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('claims_wrongtradevaluecreditclaim', 'expected', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2, blank=True))

        # Changing field 'WrongTradeValueCreditClaim.received'
        db.alter_column('claims_wrongtradevaluecreditclaim', 'received', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2, blank=True))
