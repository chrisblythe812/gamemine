...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DontReceiveClaim.first_name'
        db.add_column('claims_dontreceiveclaim', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Adding field 'DontReceiveClaim.last_name'
        db.add_column('claims_dontreceiveclaim', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DontReceiveClaim.first_name'
        db.delete_column('claims_dontreceiveclaim', 'first_name')

        # Deleting field 'DontReceiveClaim.last_name'
        db.delete_column('claims_dontreceiveclaim', 'last_name')
