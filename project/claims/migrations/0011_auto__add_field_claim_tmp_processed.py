...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Claim.tmp_processed'
        db.add_column('claims_claim', 'tmp_processed', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Claim.tmp_processed'
        db.delete_column('claims_claim', 'tmp_processed')
