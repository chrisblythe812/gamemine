...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dropship.printers'
        db.add_column('inventory_dropship', 'printers', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Dropship.label_sizes'
        db.add_column('inventory_dropship', 'label_sizes', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dropship.printers'
        db.delete_column('inventory_dropship', 'printers')

        # Deleting field 'Dropship.label_sizes'
        db.delete_column('inventory_dropship', 'label_sizes')
