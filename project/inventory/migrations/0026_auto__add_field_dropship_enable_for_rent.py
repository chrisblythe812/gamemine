...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dropship.enable_for_rent'
        db.add_column('inventory_dropship', 'enable_for_rent', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dropship.enable_for_rent'
        db.delete_column('inventory_dropship', 'enable_for_rent')
