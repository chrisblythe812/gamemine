...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        if db.backend_name != "sqlite3":
            # Removing index on 'DistributorItem', fields ['trade_price']
            db.delete_index('inventory_distributoritem', ['trade_price'])

    def backwards(self, orm):
        if db.backend_name != "sqlite3":
            # Adding index on 'DistributorItem', fields ['trade_price']
            db.create_index('inventory_distributoritem', ['trade_price'])
