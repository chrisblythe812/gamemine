...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Inventory.added_at_manual_check'
        db.add_column('inventory_inventory', 'added_at_manual_check', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Inventory.added_at_manual_check'
        db.delete_column('inventory_inventory', 'added_at_manual_check')
