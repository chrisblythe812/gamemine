...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('inventory_distributor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('address', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('inventory', ['Distributor'])

        # Adding model 'DistributorItem'
        db.create_table('inventory_distributoritem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('distributor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Distributor'])),
            ...
            ('wholesale_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
        ...
        db.send_create_signal('inventory', ['DistributorItem'])

        # Adding unique constraint on 'DistributorItem', fields ['distributor', 'item']
        db.create_unique('inventory_distributoritem', ['distributor_id', 'item_id'])

        # Adding model 'Dropship'
        db.create_table('inventory_dropship', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal('inventory', ['Dropship'])

        # Adding model 'Purchase'
        db.create_table('inventory_purchase', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('inventory', ['Purchase'])

        # Adding model 'PurchaseItem'
        db.create_table('inventory_purchaseitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('purchase', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Purchase'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Item'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('inventory', ['PurchaseItem'])

        # Adding model 'Inventory'
        db.create_table('inventory_inventory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dropship', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Dropship'], null=True, blank=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Item'])),
            ('purchase', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Purchase'], null=True, blank=True)),
            ('barcode', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'DistributorItem', fields ['distributor', 'item']
        db.delete_unique('inventory_distributoritem', ['distributor_id', 'item_id'])

        # Deleting model 'Distributor'
        db.delete_table('inventory_distributor')

        # Deleting model 'DistributorItem'
        db.delete_table('inventory_distributoritem')

        # Deleting model 'Dropship'
        db.delete_table('inventory_dropship')

        # Deleting model 'Purchase'
        db.delete_table('inventory_purchase')

        # Deleting model 'PurchaseItem'
        db.delete_table('inventory_purchaseitem')
