...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DistributorItem.is_new'
        db.add_column('inventory_distributoritem', 'is_new', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DistributorItem.is_new'
        db.delete_column('inventory_distributoritem', 'is_new')
