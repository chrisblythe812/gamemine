...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Inventory.buy_only'
        db.add_column('inventory_inventory', 'buy_only', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Inventory.buy_only'
        db.delete_column('inventory_inventory', 'buy_only')
