...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Inventory.manual_checked_dc'
        db.add_column('inventory_inventory', 'manual_checked_dc', self.gf('django.db.models.fields.related.ForeignKey')(related_name='manual_checked', null=True, to=orm['inventory.Dropship']), keep_default=False)

        # Adding field 'Inventory.manual_check_discarded'
        db.add_column('inventory_inventory', 'manual_check_discarded', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Inventory.manual_checked_dc'
        db.delete_column('inventory_inventory', 'manual_checked_dc_id')

        # Deleting field 'Inventory.manual_check_discarded'
        db.delete_column('inventory_inventory', 'manual_check_discarded')
    ...
    models = {
        ...
        'inventory.distributoritem': {
            'Meta': {'object_name': 'DistributorItem'},
            ...
            'trade_price': ('django.db.models.fields.DecimalField', [], {'default': "'0.0'", 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'trade_price_incomplete': ('django.db.models.fields.DecimalField', [], {'default': "'0.0'", 'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
        ...
        'inventory.ghostinventorydescriptor': {
            'Meta': {'object_name': 'GhostInventoryDescriptor'},
            ...
            'upc': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'inventory.inventory': {
