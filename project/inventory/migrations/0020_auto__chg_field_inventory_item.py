...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Inventory.item'
        db.alter_column('inventory_inventory', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Item'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Inventory.item'
        db.alter_column('inventory_inventory', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Item']))
