...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GhostInventoryDescriptor'
        db.create_table('inventory_ghostinventorydescriptor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('barcode', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('upc', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('dropship', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Dropship'], null=True, blank=True)),
            ('is_new', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        db.send_create_signal('inventory', ['GhostInventoryDescriptor'])


    def backwards(self, orm):
        
        # Deleting model 'GhostInventoryDescriptor'
        db.delete_table('inventory_ghostinventorydescriptor')
