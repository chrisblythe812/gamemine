...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Distributor.new_games_vendor'
        db.add_column('inventory_distributor', 'new_games_vendor', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Distributor.new_games_vendor'
        db.delete_column('inventory_distributor', 'new_games_vendor')
