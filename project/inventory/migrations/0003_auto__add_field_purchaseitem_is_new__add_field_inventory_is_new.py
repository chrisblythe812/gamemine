...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('inventory_purchaseitem', 'is_new', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Inventory.is_new'
        db.add_column('inventory_inventory', 'is_new', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Inventory.is_new'
        db.delete_column('inventory_inventory', 'is_new')
