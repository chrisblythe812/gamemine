...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Inventory.manual_checked'
        db.add_column('inventory_inventory', 'manual_checked', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Inventory.manual_checked'
        db.delete_column('inventory_inventory', 'manual_checked')
