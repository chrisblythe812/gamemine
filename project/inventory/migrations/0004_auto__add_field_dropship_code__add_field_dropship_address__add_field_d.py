...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dropship.code'
        db.add_column('inventory_dropship', 'code', self.gf('django.db.models.fields.CharField')(default='', max_length=2), keep_default=False)

        # Adding field 'Dropship.address'
        db.add_column('inventory_dropship', 'address', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Dropship.city'
        db.add_column('inventory_dropship', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Dropship.postal_code'
        db.add_column('inventory_dropship', 'postal_code', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'Dropship.lat'
        db.add_column('inventory_dropship', 'lat', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Dropship.lon'
        db.add_column('inventory_dropship', 'lon', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Changing field 'Dropship.name'
        db.alter_column('inventory_dropship', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'PurchaseItem.is_new'
        db.alter_column('inventory_purchaseitem', 'is_new', self.gf('django.db.models.fields.BooleanField')(blank=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Dropship.code'
        db.delete_column('inventory_dropship', 'code')

        # Deleting field 'Dropship.address'
        db.delete_column('inventory_dropship', 'address')

        # Deleting field 'Dropship.city'
        db.delete_column('inventory_dropship', 'city')

        # Deleting field 'Dropship.postal_code'
        db.delete_column('inventory_dropship', 'postal_code')

        # Deleting field 'Dropship.lat'
        db.delete_column('inventory_dropship', 'lat')

        # Deleting field 'Dropship.lon'
        db.delete_column('inventory_dropship', 'lon')

        # Changing field 'Dropship.name'
        db.alter_column('inventory_dropship', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'PurchaseItem.is_new'
        db.alter_column('inventory_purchaseitem', 'is_new', self.gf('django.db.models.fields.BooleanField')())
