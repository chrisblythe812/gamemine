...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Inventory.tmp_saved_dc_code'
        db.add_column('inventory_inventory', 'tmp_saved_dc_code', self.gf('django.db.models.fields.CharField')(max_length=2, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Inventory.tmp_saved_dc_code'
        db.delete_column('inventory_inventory', 'tmp_saved_dc_code')
