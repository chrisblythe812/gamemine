...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Inventory.tmp_new_dc_code_aproved'
        db.add_column('inventory_inventory', 'tmp_new_dc_code_aproved', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Inventory.tmp_new_dc_code_aproved'
        db.delete_column('inventory_inventory', 'tmp_new_dc_code_aproved')
