...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Inventory', fields ['barcode']
        db.delete_unique('inventory_inventory', ['barcode'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Inventory', fields ['barcode']
        db.create_unique('inventory_inventory', ['barcode'])
