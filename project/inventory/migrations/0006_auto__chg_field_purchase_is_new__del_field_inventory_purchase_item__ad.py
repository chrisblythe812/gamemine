...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Inventory.status'
        db.add_column('inventory_inventory', 'status', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Inventory.status'
        db.delete_column('inventory_inventory', 'status')
