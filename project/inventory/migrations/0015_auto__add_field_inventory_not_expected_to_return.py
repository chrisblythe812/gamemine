...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Inventory.not_expected_to_return'
        db.add_column('inventory_inventory', 'not_expected_to_return', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Inventory.not_expected_to_return'
        db.delete_column('inventory_inventory', 'not_expected_to_return')
